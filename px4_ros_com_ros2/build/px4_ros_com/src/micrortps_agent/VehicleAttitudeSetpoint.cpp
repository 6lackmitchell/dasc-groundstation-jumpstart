...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@c267ef4
    m_timestamp = 0;
    // m_roll_body com.eprosima.idl.parser.typecode.PrimitiveTypeCode@30ee2816
    m_roll_body = 0.0;
    // m_pitch_body com.eprosima.idl.parser.typecode.PrimitiveTypeCode@31d7b7bf
    m_pitch_body = 0.0;
    // m_yaw_body com.eprosima.idl.parser.typecode.PrimitiveTypeCode@635eaaf1
    m_yaw_body = 0.0;
    // m_yaw_sp_move_rate com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5c30a9b0
    m_yaw_sp_move_rate = 0.0;
    // m_q_d com.eprosima.idl.parser.typecode.AliasTypeCode@1ddf84b8
    memset(&m_q_d, 0, (4) * 4);
    // m_thrust_body com.eprosima.idl.parser.typecode.AliasTypeCode@1139b2f3
    memset(&m_thrust_body, 0, (3) * 4);
    // m_roll_reset_integral com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7a69b07
    m_roll_reset_integral = false;
    // m_pitch_reset_integral com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5e82df6a
    m_pitch_reset_integral = false;
    // m_yaw_reset_integral com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3f197a46
    m_yaw_reset_integral = false;
    // m_fw_control_yaw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@636be97c
    m_fw_control_yaw = false;
    // m_apply_flaps com.eprosima.idl.parser.typecode.PrimitiveTypeCode@50a638b5
    m_apply_flaps = 0;
    // m_apply_spoilers com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1817d444
    m_apply_spoilers = 0;
...
px4_msgs::msg::VehicleAttitudeSetpoint::VehicleAttitudeSetpoint(const VehicleAttitudeSetpoint &x)
{
    ...
    m_roll_reset_integral = x.m_roll_reset_integral;
    m_pitch_reset_integral = x.m_pitch_reset_integral;
    m_yaw_reset_integral = x.m_yaw_reset_integral;
...
void px4_msgs::msg::VehicleAttitudeSetpoint::serialize(eprosima::fastcdr::Cdr &scdr) const
{
    ...
    scdr << m_roll_reset_integral;
    scdr << m_pitch_reset_integral;
    scdr << m_yaw_reset_integral;
...
void px4_msgs::msg::VehicleAttitudeSetpoint::deserialize(eprosima::fastcdr::Cdr &dcdr)
{
    ...
    dcdr >> m_roll_reset_integral;
    dcdr >> m_pitch_reset_integral;
    dcdr >> m_yaw_reset_integral;
...
/*!
 * @brief This function sets a value in member roll_reset_integral
 * @param _roll_reset_integral New value for member roll_reset_integral
 */
void px4_msgs::msg::VehicleAttitudeSetpoint::roll_reset_integral(bool _roll_reset_integral)
{
m_roll_reset_integral = _roll_reset_integral;
}

/*!
 * @brief This function returns the value of member roll_reset_integral
 * @return Value of member roll_reset_integral
 */
bool px4_msgs::msg::VehicleAttitudeSetpoint::roll_reset_integral() const
{
    return m_roll_reset_integral;
}

/*!
 * @brief This function returns a reference to member roll_reset_integral
 * @return Reference to member roll_reset_integral
 */
bool& px4_msgs::msg::VehicleAttitudeSetpoint::roll_reset_integral()
{
    return m_roll_reset_integral;
}

/*!
 * @brief This function sets a value in member pitch_reset_integral
 * @param _pitch_reset_integral New value for member pitch_reset_integral
 */
void px4_msgs::msg::VehicleAttitudeSetpoint::pitch_reset_integral(bool _pitch_reset_integral)
{
m_pitch_reset_integral = _pitch_reset_integral;
}

/*!
 * @brief This function returns the value of member pitch_reset_integral
 * @return Value of member pitch_reset_integral
 */
bool px4_msgs::msg::VehicleAttitudeSetpoint::pitch_reset_integral() const
{
    return m_pitch_reset_integral;
}

/*!
 * @brief This function returns a reference to member pitch_reset_integral
 * @return Reference to member pitch_reset_integral
 */
bool& px4_msgs::msg::VehicleAttitudeSetpoint::pitch_reset_integral()
{
    return m_pitch_reset_integral;
}

/*!
 * @brief This function sets a value in member yaw_reset_integral
 * @param _yaw_reset_integral New value for member yaw_reset_integral
 */
void px4_msgs::msg::VehicleAttitudeSetpoint::yaw_reset_integral(bool _yaw_reset_integral)
{
m_yaw_reset_integral = _yaw_reset_integral;
}

/*!
 * @brief This function returns the value of member yaw_reset_integral
 * @return Value of member yaw_reset_integral
 */
bool px4_msgs::msg::VehicleAttitudeSetpoint::yaw_reset_integral() const
{
    return m_yaw_reset_integral;
}

/*!
 * @brief This function returns a reference to member yaw_reset_integral
 * @return Reference to member yaw_reset_integral
 */
bool& px4_msgs::msg::VehicleAttitudeSetpoint::yaw_reset_integral()
{
    return m_yaw_reset_integral;
}
