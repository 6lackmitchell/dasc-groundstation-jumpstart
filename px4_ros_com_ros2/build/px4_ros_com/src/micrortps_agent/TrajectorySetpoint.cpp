...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6385cb26
    m_timestamp = 0;
    // m_x com.eprosima.idl.parser.typecode.PrimitiveTypeCode@38364841
    m_x = 0.0;
    // m_y com.eprosima.idl.parser.typecode.PrimitiveTypeCode@28c4711c
    m_y = 0.0;
    // m_z com.eprosima.idl.parser.typecode.PrimitiveTypeCode@59717824
    m_z = 0.0;
    // m_yaw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@146044d7
    m_yaw = 0.0;
    // m_yawspeed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1e9e725a
    m_yawspeed = 0.0;
    // m_vx com.eprosima.idl.parser.typecode.PrimitiveTypeCode@15d9bc04
    m_vx = 0.0;
    // m_vy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@473b46c3
    m_vy = 0.0;
    // m_vz com.eprosima.idl.parser.typecode.PrimitiveTypeCode@516be40f
    m_vz = 0.0;
    // m_acceleration com.eprosima.idl.parser.typecode.AliasTypeCode@3c0a50da
    memset(&m_acceleration, 0, (3) * 4);
    // m_jerk com.eprosima.idl.parser.typecode.AliasTypeCode@3c0a50da
    memset(&m_jerk, 0, (3) * 4);
    // m_thrust com.eprosima.idl.parser.typecode.AliasTypeCode@3c0a50da
