...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@670b40af
    m_timestamp = 0;
    // m_connected com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4923ab24
    m_connected = false;
    // m_voltage_v com.eprosima.idl.parser.typecode.PrimitiveTypeCode@44c8afef
    m_voltage_v = 0.0;
    // m_voltage_filtered_v com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7b69c6ba
    m_voltage_filtered_v = 0.0;
    // m_current_a com.eprosima.idl.parser.typecode.PrimitiveTypeCode@46daef40
    m_current_a = 0.0;
    // m_current_filtered_a com.eprosima.idl.parser.typecode.PrimitiveTypeCode@12f41634
    m_current_filtered_a = 0.0;
    // m_current_average_a com.eprosima.idl.parser.typecode.PrimitiveTypeCode@13c27452
    m_current_average_a = 0.0;
    // m_discharged_mah com.eprosima.idl.parser.typecode.PrimitiveTypeCode@262b2c86
    m_discharged_mah = 0.0;
    // m_remaining com.eprosima.idl.parser.typecode.PrimitiveTypeCode@371a67ec
    m_remaining = 0.0;
    // m_scale com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5ed828d
    m_scale = 0.0;
    // m_time_remaining_s com.eprosima.idl.parser.typecode.PrimitiveTypeCode@50d0686
    m_time_remaining_s = 0.0;
    // m_temperature com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7a3d45bd
    m_temperature = 0.0;
    // m_cell_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1e7c7811
    m_cell_count = 0;
    // m_source com.eprosima.idl.parser.typecode.PrimitiveTypeCode@77ec78b9
    m_source = 0;
    // m_priority com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1a3869f4
    m_priority = 0;
    // m_capacity com.eprosima.idl.parser.typecode.PrimitiveTypeCode@77f99a05
    m_capacity = 0;
    // m_cycle_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4d3167f4
    m_cycle_count = 0;
    // m_average_time_to_empty com.eprosima.idl.parser.typecode.PrimitiveTypeCode@ed9d034
    m_average_time_to_empty = 0;
    // m_serial_number com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6121c9d6
    m_serial_number = 0;
    // m_manufacture_date com.eprosima.idl.parser.typecode.PrimitiveTypeCode@87f383f
    m_manufacture_date = 0;
    // m_state_of_health com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4eb7f003
    m_state_of_health = 0;
    // m_max_error com.eprosima.idl.parser.typecode.PrimitiveTypeCode@eafc191
    m_max_error = 0;
    // m_id com.eprosima.idl.parser.typecode.PrimitiveTypeCode@612fc6eb
    m_id = 0;
    // m_interface_error com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1060b431
    m_interface_error = 0;
    // m_voltage_cell_v com.eprosima.idl.parser.typecode.AliasTypeCode@612679d6
    memset(&m_voltage_cell_v, 0, (14) * 4);
    // m_max_cell_voltage_delta com.eprosima.idl.parser.typecode.PrimitiveTypeCode@11758f2a
    m_max_cell_voltage_delta = 0.0;
    // m_is_powering_off com.eprosima.idl.parser.typecode.PrimitiveTypeCode@e720b71
    m_is_powering_off = false;
    // m_is_required com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1b26f7b2
    m_is_required = false;
    // m_faults com.eprosima.idl.parser.typecode.PrimitiveTypeCode@491cc5c9
    m_faults = 0;
    // m_custom_faults com.eprosima.idl.parser.typecode.PrimitiveTypeCode@74ad1f1f
    m_custom_faults = 0;
    // m_warning com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6a1aab78
    m_warning = 0;
    // m_mode com.eprosima.idl.parser.typecode.PrimitiveTypeCode@462d5aee
    m_mode = 0;
    // m_average_power com.eprosima.idl.parser.typecode.PrimitiveTypeCode@69b0fd6f
    m_average_power = 0.0;
    // m_available_energy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@757942a1
    m_available_energy = 0.0;
    // m_full_charge_capacity_wh com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4a87761d
    m_full_charge_capacity_wh = 0.0;
    // m_remaining_capacity_wh com.eprosima.idl.parser.typecode.PrimitiveTypeCode@66d1af89
    m_remaining_capacity_wh = 0.0;
    // m_design_capacity com.eprosima.idl.parser.typecode.PrimitiveTypeCode@8646db9
    m_design_capacity = 0.0;
    // m_average_time_to_full com.eprosima.idl.parser.typecode.PrimitiveTypeCode@37374a5e
    m_average_time_to_full = 0;
    // m_over_discharge_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4671e53b
    m_over_discharge_count = 0;
    // m_nominal_voltage com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2db7a79b
