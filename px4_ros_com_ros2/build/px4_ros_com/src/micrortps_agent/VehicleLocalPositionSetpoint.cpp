...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@543788f3
    m_timestamp = 0;
    // m_x com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6d3af739
    m_x = 0.0;
    // m_y com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1da51a35
    m_y = 0.0;
    // m_z com.eprosima.idl.parser.typecode.PrimitiveTypeCode@16022d9d
    m_z = 0.0;
    // m_yaw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7e9a5fbe
    m_yaw = 0.0;
    // m_yawspeed com.eprosima.idl.parser.typecode.PrimitiveTypeCode@44a3ec6b
    m_yawspeed = 0.0;
    // m_vx com.eprosima.idl.parser.typecode.PrimitiveTypeCode@71623278
    m_vx = 0.0;
    // m_vy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@768b970c
    m_vy = 0.0;
    // m_vz com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5a4041cc
    m_vz = 0.0;
    // m_acceleration com.eprosima.idl.parser.typecode.AliasTypeCode@15b3e5b
    memset(&m_acceleration, 0, (3) * 4);
    // m_jerk com.eprosima.idl.parser.typecode.AliasTypeCode@15b3e5b
    memset(&m_jerk, 0, (3) * 4);
    // m_thrust com.eprosima.idl.parser.typecode.AliasTypeCode@15b3e5b
