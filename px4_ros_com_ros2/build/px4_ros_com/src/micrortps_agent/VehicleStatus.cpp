...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@79ad8b2f
    m_timestamp = 0;
    // m_nav_state com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1df82230
    m_nav_state = 0;
    // m_nav_state_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@22635ba0
    m_nav_state_timestamp = 0;
    // m_arming_state com.eprosima.idl.parser.typecode.PrimitiveTypeCode@13c10b87
    m_arming_state = 0;
    // m_hil_state com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6a01e23
    m_hil_state = 0;
    // m_failsafe com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5a955565
    m_failsafe = false;
    // m_failsafe_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6293abcc
    m_failsafe_timestamp = 0;
    // m_system_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7995092a
    m_system_type = 0;
    // m_system_id com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7fc2413d
    m_system_id = 0;
    // m_component_id com.eprosima.idl.parser.typecode.PrimitiveTypeCode@f8c1ddd
    m_component_id = 0;
    // m_vehicle_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@70be0a2b
    m_vehicle_type = 0;
    // m_is_vtol com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2133814f
    m_is_vtol = false;
    // m_is_vtol_tailsitter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4c15e7fd
    m_is_vtol_tailsitter = false;
    // m_vtol_fw_permanent_stab com.eprosima.idl.parser.typecode.PrimitiveTypeCode@23986957
    m_vtol_fw_permanent_stab = false;
    // m_in_transition_mode com.eprosima.idl.parser.typecode.PrimitiveTypeCode@23f7d05d
    m_in_transition_mode = false;
    // m_in_transition_to_fw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1e730495
    m_in_transition_to_fw = false;
    // m_rc_signal_lost com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7d3a22a9
    m_rc_signal_lost = false;
    // m_data_link_lost com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1d082e88
    m_data_link_lost = false;
    // m_data_link_lost_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@60704c
    m_data_link_lost_counter = 0;
    // m_high_latency_data_link_lost com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6b19b79
    m_high_latency_data_link_lost = false;
    // m_engine_failure com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2a32de6c
    m_engine_failure = false;
    // m_mission_failure com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7692d9cc
    m_mission_failure = false;
    // m_geofence_violated com.eprosima.idl.parser.typecode.PrimitiveTypeCode@75f32542
    m_geofence_violated = false;
    // m_failure_detector_status com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7f1302d6
    m_failure_detector_status = 0;
    // m_onboard_control_sensors_present com.eprosima.idl.parser.typecode.PrimitiveTypeCode@43ee72e6
    m_onboard_control_sensors_present = 0;
    // m_onboard_control_sensors_enabled com.eprosima.idl.parser.typecode.PrimitiveTypeCode@23529fee
    m_onboard_control_sensors_enabled = 0;
    // m_onboard_control_sensors_health com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4fe767f3
    m_onboard_control_sensors_health = 0;
    // m_latest_arming_reason com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2805c96b
    m_latest_arming_reason = 0;
    // m_latest_disarming_reason com.eprosima.idl.parser.typecode.PrimitiveTypeCode@184cf7cf
    m_latest_disarming_reason = 0;
    // m_armed_time com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2fd6b6c7
    m_armed_time = 0;
    // m_takeoff_time com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5bfa9431
    m_takeoff_time = 0;
