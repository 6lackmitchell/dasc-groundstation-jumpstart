...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@77e4c80f
    m_timestamp = 0;
    // m_timestamp_sample com.eprosima.idl.parser.typecode.PrimitiveTypeCode@35fc6dc4
    m_timestamp_sample = 0;
    // m_xy_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7fe8ea47
    m_xy_valid = false;
    // m_z_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@226a82c4
    m_z_valid = false;
    // m_v_xy_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@731f8236
    m_v_xy_valid = false;
    // m_v_z_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@255b53dc
    m_v_z_valid = false;
    // m_x com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1dd92fe2
    m_x = 0.0;
    // m_y com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6b53e23f
    m_y = 0.0;
    // m_z com.eprosima.idl.parser.typecode.PrimitiveTypeCode@64d2d351
    m_z = 0.0;
    // m_delta_xy com.eprosima.idl.parser.typecode.AliasTypeCode@1b68b9a4
    memset(&m_delta_xy, 0, (2) * 4);
    // m_xy_reset_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4f9a3314
    m_xy_reset_counter = 0;
    // m_delta_z com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3b2c72c2
    m_delta_z = 0.0;
    // m_z_reset_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@491666ad
    m_z_reset_counter = 0;
    // m_vx com.eprosima.idl.parser.typecode.PrimitiveTypeCode@176d53b2
    m_vx = 0.0;
    // m_vy com.eprosima.idl.parser.typecode.PrimitiveTypeCode@971d0d8
    m_vy = 0.0;
    // m_vz com.eprosima.idl.parser.typecode.PrimitiveTypeCode@51931956
    m_vz = 0.0;
    // m_z_deriv com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2b4a2ec7
    m_z_deriv = 0.0;
    // m_delta_vxy com.eprosima.idl.parser.typecode.AliasTypeCode@1b68b9a4
    memset(&m_delta_vxy, 0, (2) * 4);
    // m_vxy_reset_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@564718df
    m_vxy_reset_counter = 0;
    // m_delta_vz com.eprosima.idl.parser.typecode.PrimitiveTypeCode@51b7e5df
    m_delta_vz = 0.0;
    // m_vz_reset_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@18a70f16
    m_vz_reset_counter = 0;
    // m_ax com.eprosima.idl.parser.typecode.PrimitiveTypeCode@62e136d3
    m_ax = 0.0;
    // m_ay com.eprosima.idl.parser.typecode.PrimitiveTypeCode@c8e4bb0
    m_ay = 0.0;
    // m_az com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6279cee3
    m_az = 0.0;
    // m_heading com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4206a205
    m_heading = 0.0;
    // m_delta_heading com.eprosima.idl.parser.typecode.PrimitiveTypeCode@29ba4338
    m_delta_heading = 0.0;
    // m_heading_reset_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@57175e74
    m_heading_reset_counter = 0;
    // m_heading_good_for_control com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7bb58ca3
    m_heading_good_for_control = false;
    // m_xy_global com.eprosima.idl.parser.typecode.PrimitiveTypeCode@c540f5a
    m_xy_global = false;
    // m_z_global com.eprosima.idl.parser.typecode.PrimitiveTypeCode@770c2e6b
    m_z_global = false;
    // m_ref_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1a052a00
    m_ref_timestamp = 0;
    // m_ref_lat com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4d826d77
    m_ref_lat = 0.0;
    // m_ref_lon com.eprosima.idl.parser.typecode.PrimitiveTypeCode@61009542
    m_ref_lon = 0.0;
    // m_ref_alt com.eprosima.idl.parser.typecode.PrimitiveTypeCode@77e9807f
    m_ref_alt = 0.0;
    // m_dist_bottom com.eprosima.idl.parser.typecode.PrimitiveTypeCode@448ff1a8
    m_dist_bottom = 0.0;
    // m_dist_bottom_valid com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1a38c59b
    m_dist_bottom_valid = false;
    // m_dist_bottom_sensor_bitfield com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7f77e91b
    m_dist_bottom_sensor_bitfield = 0;
    // m_eph com.eprosima.idl.parser.typecode.PrimitiveTypeCode@44a664f2
    m_eph = 0.0;
    // m_epv com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7f9fcf7f
    m_epv = 0.0;
    // m_evh com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2357d90a
    m_evh = 0.0;
    // m_evv com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6328d34a
    m_evv = 0.0;
    // m_vxy_max com.eprosima.idl.parser.typecode.PrimitiveTypeCode@145eaa29
    m_vxy_max = 0.0;
    // m_vz_max com.eprosima.idl.parser.typecode.PrimitiveTypeCode@15bb6bea
    m_vz_max = 0.0;
    // m_hagl_min com.eprosima.idl.parser.typecode.PrimitiveTypeCode@8b96fde
    m_hagl_min = 0.0;
    // m_hagl_max com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2d2e5f00
    m_hagl_max = 0.0;
